<template>
  <div>
    <el-table
      ...
      :row-key="(row) => row.id"
      height="70vh"
      @selection-change="handleSelectionChange?handleSelectionChange:handleSelectionChangeDefault"
      @row-click="handleRowClick?handleRowClick:handleRowClickDefault"
    >
      <el-table-column
        type="selection"
        width="55"
...
const handleSelectionChangeDefault = (row) => {
  console.log(row);
};
