...
const handleFormData = (data) => {
  ...
  for (let i in formData.value.expenseReason.options) {
    formData.value.expenseReason.options[i] = { label: "", value: "", category: "" };
  }

  for (let i in categoryOptions.value) {
    console.log("i", i, categoryOptions.value[i]);
    formData.value.expenseReason.options[i].category =
      categoryOptions.value[i].category;
    formData.value.expenseReason.options[i].label =
      categoryOptions.value[i].describe;
    formData.value.expenseReason.options[i].value = categoryOptions.value[i].code;
  }
