...
const getCategoryOptions = async () => {
  const resp = await ccodeService.getCategoryOptions();
  dataUtils.processRespData(categoryOptions, resp, dataUtils.processMap.ARRAY);
};
...
const handleFormData = (data) => {
  ...
  formData.value.category.options = categoryOptions.value;
