<template>
  <div style="color: #666; width: 100vw">
    <el-row :gutter="40">
      <el-col ::span="{ xs: 22, sm: 22, md: 20 lg: 20, xl: 20 }"> ECS费用统计系统</el-col>
      <el-col :span="2" style="display: flex; justify-content: flex-end">
        <el-dropdown @command="handleCommand">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item :command="item.command" v-for="(item, index) in dropItemList" :key="index">{{ item.label }}</el-dropdown-item>
            </el-dropdown-menu>
          </template>
        </el-dropdown>
      </el-col>
