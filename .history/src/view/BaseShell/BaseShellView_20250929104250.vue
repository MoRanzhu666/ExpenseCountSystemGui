<template>
  <el-container class="base-shell" :style="`height: 100vh;`">
    <!-- Header -->
    <el-header
      :style="`height: ${headerHeight}; display:flex; align-items:center; padding:0 20px; background:#f5f7fa;`"
    >
      <slot name="header">
    ...
    <el-container>
      <el-aside
        :width="leftWidth"
        :style="`padding:20px; background:#ffffff; border-right:1px solid #ebeef5;`"
      >
      ...
      <el-main :style="`padding:20px; background: #fff;`">
        <div
          ...
          :style="`height: calc(100vh - ${topAndBottomHeight}); display:flex; align-items:center; justify-content:center;`"
        >
          <slot> Center Content </slot>
        </div>
      </el-main>
    </el-container>
